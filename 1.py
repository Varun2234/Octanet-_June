...
lblinfo = Label(Tops , font=('aria',30,'bold'),text="ATM MACHINE INTERFACE" , fg="Powder Blue", bg ="black", bd=10 , anchor='w')
...
def bank():
    global acca
    accno=["2000","2001","2002","2002","2003","2004","2005","2006","2007","2008","2009","2010"]
    account = number.get()
    if account in accno:
        label.config(text="Registerd User")
        bank = {"2000":10000,"2001":20000,"2002":30000,"2002":40000,"2003":50000,"2004":60000,"2005":70000,"2006":80000,"2007":85000,"2008": 90000,"2009":95000,"2010":100000}
        balance = bank[account]
        acca = balance
    else:
        label.config(text="Not Registered User")
...
btnwithdraw =Button(f2,padx=16,pady=4 , bd=10, fg="black",font=('ariel',16,'bold'), width=7,text="WITHDRAWN", bg="Powder Blue", command=withdraw)
